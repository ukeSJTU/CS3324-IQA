"""
Visualization script for HyperIQA training and evaluation results.
...
def parse_args():
    parser = argparse.ArgumentParser(description='Visualize HyperIQA training and evaluation results')
